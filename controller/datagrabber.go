...
func (d *DataGrabberController) SaveDataGrabberWizard(r *knot.WebContext) interface{} {
	...
	success, message := d.AutoGenerateDataSources(payload)
	_ = success
	if err != nil {
...
func (d *DataGrabberController) AutoGenerateDataSources(payload *colonycore.DataGrabberWizardPayload) (bool, string) {
