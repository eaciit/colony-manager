...
var (
	...
	IncludeFiles []string = []string{"views/_head.html", "views/_loader.html", "views/_miniloader.html", "views/page-user.html", "views/page-session.html", "views/page-group.html", "views/page-servers.html", "views/page-databrowserdesign.html", "views/page-widgetgrid.html"}
