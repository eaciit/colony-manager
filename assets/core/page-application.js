...
apl.applicationColumns = ko.observableArray([
	...
	{ title: "", width: 100, attributes: { style: "text-align: center;" }, template: function (d) {
		return [
			"<button class='btn btn-sm btn-default btn-text-success btn-start tooltipster' id='excludethis' title='Deploy to servers' onclick='apl.deploy(\"" + d._id + "\")()'><span class='fa fa-plane'></span></button>",
